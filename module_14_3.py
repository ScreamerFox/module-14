...
async def get_buying_list(message):
    with open("imgs/2.jpg", 'rb') as img:
        await message.answer_photo(img, f"Название: BCAA | Описание: витамины | Цена: 1000")
    with open("imgs/4.jpg", 'rb') as img:
        await message.answer_photo(img, f"Название: ANABOLS | Описание: анаболики | Цена: 2000")
    with open("imgs/31.jpg", 'rb') as img:
        await message.answer_photo(img, f"Название: Set FitMAX | Описание: сет спортивного питания | Цена: 3000")
    with open("imgs/3.jpeg", 'rb') as img:
        await message.answer_photo(img, f"Название: Нормальная домашняя еда | Описание: колбаска, орешки, мяско, яичко и много чего | Цена: Бесценно")
